        ...
        children=[
            ...
            html.Div(
                ...
                children=[
                    ...
                    html.Button(
                        id="learn-more-button", children="More Options", n_clicks=0
                    ),
                    html.A(
...
def build_tab_1():
    return [
        ...
        html.Div(
            ...
            children=html.P(
                "Use default control limits to establish a benchmark, or upload customized config file."
            ),
        ),
        html.Div(
            id="settings-menu",
